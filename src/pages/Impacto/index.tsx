...
const Impacto = () => {
  return (
    <div className="content-impacto container-fluid content-side fluid-header-actions">
      <div className="row mb-24">
        <div className="xs-12">
          <TitleHeaderActionIcon title="Impacto" />
        </div>
        <div className="md-6 mb-12">
          <div className="card-impacto">
            ...
            <div className="div-btn">
              <LinkButton className="button-card btn" to="/minha-carteira">Comprar árvores</LinkButton>
            </div>
          </div>
        </div>
